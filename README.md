...
**This is a modified version of LIBERO and subtask labelling scripts is added to generate subtasks for LIBERO-10 (see [subtask-labelling](#subtask-labelling)). The label is generated by replaying the demo and check the state-change provided inside the original dataset. **
...
- [Datasets](#Dataset)
  - [Subtask-Labelling](#subtask-labelling)
